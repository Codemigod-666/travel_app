...
const CampSite = ({backgroundImage, title, subtitle, peopleJoined}: CampProps) => {
  return (
    <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:roundex-r-5xl 2xl:rounded-5xl`}>
...
const Camp = () => {
  ...
  //       <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl sl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
